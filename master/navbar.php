<?php
ini_set("date.timezone","America/El_Salvador");//se configura la zona horaria que se muestra en el menu del sitio privado
include("scripts.php")
?>
...
<li><a class="tipografia waves-effect waves-light" href="buscar.php">Buscar tu Reserva</a></li>
