...
<div class="row black">
<div class="col s12 l6">
<img class="responsive-img valign-wrapper hide-on-med-and-down" src="img/eje2.jpg">
</div>
<div class="col s12 l6">
<h5 class="white-text textosindex center-align">Mision</h5>
<hr>
...
<div class="row">
<div class="col s12 l6">
<h5 class="black-text textosindex center-align">Vision</h5>
<hr>
